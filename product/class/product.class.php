...
class Product extends CommonObject
{
	...
	public function load_stock($option = '', $includedraftpoforvirtual = null, $dateofvirtualstock = null)
	{
		...
		$excluded_warehouse_id = getDolGlobalString('EXCLUDE_WAREHOUSE_ID_SALES'); // Add this line
		...
		if (!empty($excluded_warehouse_id) && is_numeric($excluded_warehouse_id)) { // Add this block
		    $sql .= " AND w.rowid != ".((int) $excluded_warehouse_id);
		}
